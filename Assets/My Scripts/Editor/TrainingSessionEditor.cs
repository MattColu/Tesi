...
public class TrainingSessionEditor : EditorWindow
{
    ...
    void SetupTrainingScene(TrainingSettings settings) {
    ...
    void InstantiateTracks(TrainingSettings settings) {
    ...
    void InstantiateKarts(TrainingSettings settings) {
